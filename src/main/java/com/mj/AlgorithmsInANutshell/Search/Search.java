package com.mj.AlgorithmsInANutshell.Search;

/**
 * @file Search.java    Task to perform searches in unordered array
 * @brief
 ...
 * this collection and return its time in milliseconds.
 *
